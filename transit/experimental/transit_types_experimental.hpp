...
public:
  ...
  bool operator==(Network const & rhs) const;
  bool IsEqualForTesting(Network const & network) const;
  bool IsValid() const;
...
public:
  ...
  bool operator==(Route const & rhs) const;
  bool IsEqualForTesting(Route const & route) const;
  bool IsValid() const;
...
private:
  DECLARE_TRANSIT_TYPES_FRIENDS
  DECLARE_VISITOR_AND_DEBUG_PRINT(Route, visitor(m_id, "id"), visitor(m_routeType, "type"),
                                  visitor(m_title, "title"), visitor(m_color, "color"),
...
private:
  ...
  DECLARE_VISITOR_AND_DEBUG_PRINT(Stop, visitor(m_id, "id"), visitor(m_ids, "id_bundle"),
                                  ...
                                  visitor(m_title, "title"), visitor(m_timetable),
